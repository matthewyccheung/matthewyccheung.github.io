---
layout: post
title:  "RL Foundations: TRPO and PPO"
math: true
--- 
...
| Concept | TRPO | PPO |
|---|---|---|
| Goal | Improve policy safely | Improve policy safely |
| Main mechanism | Hard KL trust region | Clipped surrogate objective |
| Optimization type | Constrained, second-order approximation | Unconstrained, first-order gradient optimization |
| KL handling | Explicit constraint | Usually monitored; sometimes early stopping |
| Complexity | More complex | Simpler |
| Step control | Conjugate gradient plus line search | Clipping and minibatch SGD/Adam |

TRPO says:

$\[
\text{Improve the policy, but stay inside this KL ball.}
\]$

PPO says:

$\[
\text{Improve the policy, but the objective stops rewarding excessive probability-ratio changes.}
\]$
...
## 30. Misunderstanding: “The surrogate approximates \(\pi\) with \(\pi'\).”
...
## 31. Misunderstanding: “If we already observed the trajectory, why optimize anything?”
...
## 32. Misunderstanding: “How can we know \(r_{t+1}\) at time \(t\)?”
...
## 33. Misunderstanding: “The value function is known before RL.”
...
## 34. Misunderstanding: “The policy is fixed before RL.”
...
## 35. Misunderstanding: “CPI is TRPO with temporal weighting.”
...
## 36. Misunderstanding: “The symbol \(r_t\) always means reward.”
